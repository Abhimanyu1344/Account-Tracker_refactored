...
# )
# from backend.common import _normalise_base, _normalise_for_fuzzy, _fuzzy
...
#         # #33: Load validator once, reuse across verticals
#         self.validator = None
#         self.kb_bridge = {}
...
#                          == "No open bills found for this client"]
...
#             "bills_cleared":           int((d1["_Status"] == "CLEARED").sum()),
#             "bills_partial":           int((d1["_Status"] == "PARTIALLY_CLEARED").sum()),
#             "bills_open":              int((d1["_Status"] == "OPEN").sum()),
...
#                     "Suggested_Client":  resolution.get("suggestion", ""),
#                     "Action_Required":   "Add to KB / PNM",
#                 }
...
#                         s3.at[entry_idx, "_Status"] = "FULLY_APPLIED"
#                     else:
#                         s3.at[entry_idx, "_Status"] = "PARTIALLY_APPLIED"
...
#                     d1.at[bill_idx, "_Status"] = "CLEARED"
#                 else:
#                     d1.at[bill_idx, "_Status"] = "PARTIALLY_CLEARED"
...
#                 "Action_Required":   "No open bills found for this client",
#             })
#             return False
...
#             # Check tolerance against bill remaining amount
...
#                 # when payment slightly exceeds bill within tolerance
...
#                 )
#                 # Update status
#                 if d1.at[bill_idx, "_Remaining"] <= CLEARING_ROUNDING_THRESHOLD:  # ₹1 rounding tolerance
#                     d1.at[bill_idx, "_Status"] = "CLEARED"
#                 else:
#                     d1.at[bill_idx, "_Status"] = "PARTIALLY_CLEARED"
...
#                         s3.at[suspense_idx, "_Status"] = "FULLY_APPLIED"
#                     else:
#                         s3.at[suspense_idx, "_Status"] = "PARTIALLY_APPLIED"
...
#                 # Payment larger than bill — apply full bill, carry remainder to next
#                 applied = bill_remaining
#                 d1.at[bill_idx, "_Remaining"]      = 0.0
#                 d1.at[bill_idx, "_Cleared_Amount"] = (
#                     d1.at[bill_idx, "_Cleared_Amount"] + applied
#                 )
#                 d1.at[bill_idx, "_Status"] = "CLEARED"
...
#                 "Method":            method,
#                 "Suggested_Client":  resolved_name,
#                 "Action_Required":   "Amount does not match any open bill within tolerance",
#             })
...
#     rec = Reconciler(kb_path=kb_path)
