...
#     "PARTIALLY_CLEARED":  "Partly Settled",
# }
...
# def translate_debtors_status(val: str) -> str:
#     return _DEBTORS_STATUS_MAP.get(str(val).upper().strip(), val)

# def translate_suspense_status(val: str) -> str:
#     return _SUSPENSE_STATUS_MAP.get(str(val).upper().strip(), val)
...
# def translate_gap_reason(val: str) -> str:
#     return _GAP_REASON_MAP.get(str(val).strip(), val)
...
# def translate_unresolvable_reason(val: str) -> str:
#     return _UNRESOLVABLE_REASON_MAP.get(str(val).strip(), val)
