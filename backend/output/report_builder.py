...
#         df_s["_p"] = df_s["Status"].str.upper().map(priority).fillna(3)
...
#         total = len(grp)
#         cl = len(grp[grp[status_col].str.upper() == "CLEARED"])           if status_col else 0
#         pa = len(grp[grp[status_col].str.upper() == "PARTIALLY_CLEARED"]) if status_col else 0
#         op = len(grp[grp[status_col].str.upper() == "OPEN"])              if status_col else 0
